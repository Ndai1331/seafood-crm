...
export function init(id) {
    ...
    if (el === null) {
        // The module is imported asynchronously, so the dialog can already be gone by the
        // time init runs — e.g. a layout that renders a modal and then redirects. Throwing
        // here would surface as an unhandled JSException and kill the Blazor circuit.
        return
    }
