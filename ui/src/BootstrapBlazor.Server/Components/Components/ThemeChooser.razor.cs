...
public partial class ThemeChooser
{
    ...
    protected override void OnInitialized()
    {
        ...
        // Themes is only declared in appsettings.Development.json, so it is null under
        // ASPNETCORE_ENVIRONMENT=Production. Without this guard Select() throws and the
        // exception escapes OnInitialized, terminating the whole Blazor circuit -> blank page.
